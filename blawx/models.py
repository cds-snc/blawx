    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["rule_slug", "owner"], name="unique_owner_and_rule_slug"
            )
        ]
        permissions = [
...
class Workspace(models.Model):
    ruledoc = models.ForeignKey(
        RuleDoc, related_name="workspaces", on_delete=models.CASCADE
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["ruledoc", "workspace_name"],
                name="unique_workspace_and_ruledoc",
            )
        ]
...
class BlawxTest(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["ruledoc", "test_name"], name="unique_test_and_ruledoc"
            )
        ]
        permissions = [
            ("run", "Run Test"),
